...
def verify_payment(request, ref):
    # //here is where i would update some sstuffs in the student and payment model like the payment status
    # //also think of a serializer here to update students status when a term changes
